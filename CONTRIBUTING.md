...
Thanks for contributing to MAOS-ECS.
...
- Controller software and scripts: .c, .cpp, .py, .ps1
- Simulation tooling code
- Test automation logic

Non-code (CC BY-NC-SA):

- Requirements and architecture docs
- Thermal/pressure studies and reports
- CAD, schematics, diagrams, and published datasets

## Pull Request Expectations

- Keep assumptions and constraints explicit.
- Include evidence for claims and design decisions.
- Call out interface impacts (electrical, mechanical, control, fluid/air).
